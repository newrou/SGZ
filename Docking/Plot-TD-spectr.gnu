...
#set nokey
plot \
     "1ah1~YDPEYRNFWGCG-all-td.csv" using (50.0*$5):4:(50.0*$5):(0.00000) with xyerrorbars ps 0 lw 2 lc rgb "red"   ti "YDPEYRNFWGCG (+) 45%", \
     "1ah1~EGLNRPSGGCG-all-td.csv"  using (50.0*$5):4:(50.0*$5):(0.00000) with xyerrorbars ps 0 lw 2 lc rgb "green" ti "EGLNRPSGGCG (-) 55%"
