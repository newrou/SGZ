...
#set nokey
plot \
     "1ah1~YDPEYRNFWGCG-all-td.csv" using (100.0*$5):4:(10.0*sqrt($5)) with points lc rgb "red"   pt 6 lw 0 ps variable ti "YDPEYRNFWGCG (+) 63%", \
     "1ah1~EGLNRPSGGCG-all-td.csv"  using (100.0*$5):4:(10.0*sqrt($5)) with points lc rgb "green" pt 6 lw 0 ps variable ti "EGLNRPSGGCG (-) 37%"
...
#set nokey
plot \
     "1ah1~YDPEYRNFWGCG-all-td.csv" using (50.0*$5):4:(50.0*$5):(0.00000) with xyerrorbars ps 0 lw 2 lc rgb "red"   ti "YDPEYRNFWGCG (+) 63% (min -29.71 kJ/mol)", \
     "1ah1~EGLNRPSGGCG-all-td.csv"  using (50.0*$5):4:(50.0*$5):(0.00000) with xyerrorbars ps 0 lw 2 lc rgb "green" ti "EGLNRPSGGCG (-) 37% (min -28.03 kJ/mol)"
